...
<div class="pd-ltr-20 xs-pd-20-10">
    ...
    <div class="row">
            ...
            <div
                class="alert alert-danger alert-dismissible fade show"
                role="alert">
                <strong>Data Gagal Diubah, Pengisian form tidak lengkap</strong>
                <button
                    type="button"
                    class="close"
                    data-dismiss="alert"
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="task-title row align-items-center">
                                                    ...
                                                    <div class="col-md-4 col-sm-12 text-right">
                                                        <a
                                                            ...
                                                            class="bg-light-blue btn text-blue weight-500"><i class="ion-plus-round"></i> Add</a>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="modal-body pd-0">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <a
                                                                                ...
                                                                                data-placement="bottom"
                                                                                title=""
                                                                                data-original-title="Remove Task"><i class="ion-minus-circled"></i></a>
                                                                            <form>
                                                                                <div class="form-group row">
                                                                                    <label class="col-md-4">Task Type</label>
                                                                                    <div class="col-md-8">
                                                                ...
                                                                <div class="add-more-task">
                                                                    <a
                                                                        ...
                                                                        data-placement="bottom"
                                                                        title=""
                                                                        data-original-title="Add Task"><i class="ion-plus-circled"></i> Add
                                                                        More Task</a>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                    ...
                                    <div
                                        ...
                                        <div class="profile-setting">
                                            <form action="{{url('guru/update/' . encrypt($data->id))}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                        ...
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="col-sm-12 col-md-10">
                                                                <select class="custom-select col-12" name="jk">
                                                                    ...
                                                                    <option value="{{ $jk->nilai }}" @if($jk->nilai == $data->jk) selected @endif>{{ $jk->nilai }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="col-sm-12 col-md-10">
                                                                <select class="custom-select col-12" name="jabatan">
                                                                    ...
                                                                    <option value="{{ $jabatan->nilai }}" @if($jabatan->nilai == $data->jabatan) selected @endif>{{ $jabatan->nilai }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <div class="col-sm-12 col-md-10">
                                                                <select class="custom-select col-12" name="role">
                                                                    ...
                                                                    <option value="{{ $role->nilai }}" @if($role->nilai == $data->role) selected @endif>{{ $role->nilai }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
